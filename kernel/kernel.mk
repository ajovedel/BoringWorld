...
KOBJS := assert.o main.o raise.o install_handler.o swi_handler.o irq_handler.o c_swi_handler.o c_irq_handler.o syscalls.o exit.o call_user.o irq_setup.o timer_setup.o interrupt_setup.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
